...
export default function SizeGuide() {
  return (
    <>
      <Helmet>
        <title>Größentabelle für Damenmode | Aegean's Rosa</title>
        <meta
          name="description"
          content="Finde die passende Größe für dein Outfit. Unser Größenratgeber hilft dir beim perfekten Einkauf."
        />
      </Helmet>
      ...
      <Box sx={{ padding: 4 }}>
        ...
        <Typography variant="body1">
          ...
          aus und vergleiche deine Maße mit unseren Tabellen. So misst du
          richtig.
        </Typography>
        ...
        <Paper elevation={3} sx={{ marginY: 4, padding: 3 }}>
          <Grid container spacing={3} alignItems="center">
            ...
            <Grid size={{ xs: 12, md: 8 }}>
              ...
              <Typography>
                Miss an der breitesten Stelle deiner Hüfte.
              </Typography>
            </Grid>
          </Grid>
        </Paper>
