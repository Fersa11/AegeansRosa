  ...
  return (
    <Box sx={{ pl: 3, marginBottom: 2 }}>
      ...
      <Typography variant="h7" sx={{ marginBottom: 2 }}>
        ...
        Einwilligung des Nutzers oder wenn die Verarbeitung durch gesetzliche
      ...
      <List>
        ...
        <ListItem>auf Einschränkung der Verarbeitung (Art. 18 DSGVO)</ListItem>
      ...
      <Typography sx={{ marginBottom: 2 }}>
        ...
        Browsertyp, Betriebssystem, Referrer-URL. Rechtsgrundlage: Art. 6 Abs. 1
        lit. f DSGVO (berechtigtes Interesse an sicherem Betrieb der Website)
      </Typography>
      <Typography variant="h6" sx={{ marginTop: 2, marginBottom: 2 }}>
        5. Cookies
      </Typography>
      ...
      <Typography sx={{ marginBottom: 2 }}>
        ...
        ersten Besuch unserer Website wird Ihnen ein Banner angezeigt, über das
        Sie auswählen können, ob Sie nur technisch notwendige Cookies oder auch
        Statistik-/Marketing-Cookies zulassen möchten. Ihre Auswahl wird in
        einem Cookie auf Ihrem Endgerät gespeichert, sodass die Abfrage bei
      ...
      <List dense disablePadding sx={{ listStyleType: "disc" }}>
        ...
        <ListItem sx={{ display: "list-item", ml: 2 }}>
          ...
          Dabei findet keine Verbindung zu Servern von Google statt. Es erfolgt
          keine Übertragung personenbezogener Daten an Dritte. Rechtsgrundlage:
          Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an einer
          einheitlichen und ansprechenden Darstellung unseres Online-Angebots)
        </ListItem>
      </List>
    </Box>
  );
