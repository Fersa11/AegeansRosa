...
export default function Impressum() {
  return (
    <Typography sx={{ pl: 2 }}>
      <Typography sx={{ marginBottom: 2, fontVariant: "h2" }}>
        Impressum
      </Typography>
      <Typography>Angaben gemäß § 5 DDG</Typography>
      ...
      <Typography sx={{ fontWeight: "bold" }}>Vertreten durch:</Typography>
      <Typography>fer sa</Typography>
      {/* <Typography sx={{ fontWeight: "bold" }}>
        Telefon: 2304-56899652
      </Typography> */}
      <Typography sx={{ fontWeight: "bold" }}>
        E-Mail: <a href="mailto:f@gmail.com">f@gmail.com</a>
      </Typography>
      <Typography sx={{ fontWeight: "bold" }}>Registereintrag: </Typography>
      <Typography>Eintragung im Handelsregister.</Typography>
      <Typography>Registergericht: Schwerte </Typography>
      <Typography>Registernummer: 1111111</Typography>
      <Typography sx={{ fontWeight: "bold" }}>Umsatzsteuer-ID: </Typography>
      <Typography>
        Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz:
        319/45454
      </Typography>
      <Typography sx={{ fontWeight: "bold" }}>Wirtschafts-ID: </Typography>
      <Typography sx={{ marginBottom: 2 }}>319/xxxx</Typography>
      <Typography sx={{ fontWeight: "bold" }}>Haftungsausschluss: </Typography>
      <Typography sx={{ fontWeight: "bold" }}>Haftung für Inhalte</Typography>
      ...
      <Typography sx={{ fontWeight: "bold" }}>Datenschutz</Typography>
      <Typography sx={{ marginBottom: 2 }}>
      ...
      <Typography sx={{ fontWeight: "bold" }}>Google Analytics</Typography>
      <Typography sx={{ marginBottom: 2 }}>
      ...
      <Typography sx={{ fontWeight: "bold" }}>Google AdSense</Typography>
      <Typography>
        <Typography sx={{ marginBottom: 2 }}>
